...
public class ChatActivity extends AppCompatActivity {
    ...
    private String myUrlImage, currentUserID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myUrlImage = getIntent().getExtras().get("myUrl").toString();
        controle = (boolean) getIntent().getExtras().get("controle");
        ...
        Picasso.get().load(messageReceiverImage).placeholder(R.drawable.padrao).into(userImage);
    ...
    private void sendMessageFromCamera() {
            ...
            messageTextBody.put("message", myUrlImage);
            messageTextBody.put("name", myUrlImage);
